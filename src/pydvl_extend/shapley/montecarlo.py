...
reduce computation :func:`pruned_montecarlo_shapley`.
...
from pydvl_extend.shapley.pruned import NoPruning, PruningPolicy
...
def _permutation_montecarlo_shapley(
    ...
    *,
    ...
    :param pruning: A callable which decides whether to interrupt
...
def permutation_montecarlo_shapley(
    ...
    *,
    ...
    :param pruning: An optional callable which decides whether to
