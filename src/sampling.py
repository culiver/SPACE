...
def mnist_noniid_specified(dataset, num_users, user_shards):
    """
    Sample non-I.I.D client data from MNIST dataset
    :param dataset:
    :param num_users:
...
def cifar_noniid_specified(dataset, num_users, user_shards):
    """
    Sample non-I.I.D client data from CIFAR10 dataset
    :param dataset:
    :param num_users:
...
def partition_CIFAR_dataset(
    ...
    dict_users = {i: np.array([]) for i in range(n_clients)}
    ...
    for idx_client, n_sample in enumerate(n_samples):
        ...
        for k in range(n_classes):
            ...
            if k < 9:
                try:
                    ...
                    print(matrix[idx_client, k], n_sample)
                    exit()
            if k == 9:
        ...
        dict_users[idx_client] = np.concatenate((dict_users[idx_client], clients_idx_i), axis=0)
